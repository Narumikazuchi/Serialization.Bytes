...
partial class IntegratedSerializationStrategies
{
    ...
    partial struct Single
    {
        ...
        private static IDeserializationStrategy<System.Byte[], System.Single> s_DeserializationStrategy = s_Reference;
        private static ISerializationStrategy<System.Byte[], System.Single> s_SerializationStrategy = s_Reference;
    }

    partial struct Single : IDeserializationStrategy<System.Byte[]>
    {
    ...
    partial struct Single : ISerializationStrategy<System.Byte[]>
    {
        System.Byte[] ISerializationStrategy<System.Byte[]>.Serialize(Object? input)
        {
            if (input is not Single value)
            {
