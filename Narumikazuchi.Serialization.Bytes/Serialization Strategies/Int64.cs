...
partial class IntegratedSerializationStrategies
{
    ...
    partial struct Int64
    {
        ...
        private static IDeserializationStrategy<System.Byte[], System.Int64> s_DeserializationStrategy = s_Reference;
        private static ISerializationStrategy<System.Byte[], System.Int64> s_SerializationStrategy = s_Reference;
    }

    partial struct Int64 : IDeserializationStrategy<System.Byte[]>
    {
    ...
    partial struct Int64 : ISerializationStrategy<System.Byte[]>
    {
        System.Byte[] ISerializationStrategy<System.Byte[]>.Serialize(Object? input)
        {
            if (input is not Int64 value)
            {
