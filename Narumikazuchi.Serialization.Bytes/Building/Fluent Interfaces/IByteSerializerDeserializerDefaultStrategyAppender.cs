    ...
    IByteSerializerDeserializerStrategyAppender<TSerializable>
{
    ...
    /// <see cref="DateOnly"/>, <see cref="DateTime"/>, <see cref="Decimal"/>, <see cref="Double"/>, <see cref="Guid"/>, <see cref="Half"/>,
    /// <see cref="Int16"/>, <see cref="Int32"/>, <see cref="Int64"/>, <see cref="IntPtr"/>, <see cref="SByte"/>, <see cref="Single"/>,
    /// <see cref="String"/>, <see cref="TimeOnly"/>, <see cref="TimeSpan"/>, <see cref="UInt16"/>, <see cref="UInt32"/>, <see cref="UInt64"/>, <see cref="UIntPtr"/>.
    /// </remarks>
